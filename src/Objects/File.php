 ...
 * @property integer $file_size Optional. File size in bytes, if known
 * @property string $file_path Optional. File path. Use https://api.telegram.org/file/bot/ to get the file.
 */
