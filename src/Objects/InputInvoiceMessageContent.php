 ...
 * @property integer $photo_size Optional. Photo size
 * @property integer $photo_width Optional. Photo width
 * @property integer $photo_height Optional. Photo height
 ...
 * @property boolean $send_phone_number_to_provider Optional. Pass True, if user's phone number should be sent to provider
 * @property boolean $send_email_to_provider Optional. Pass True, if user's email address should be sent to provider
