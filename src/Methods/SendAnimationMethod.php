 ...
 * @property integer $duration __Required: Optional__. Duration of sent animation in seconds
 * @property integer $width __Required: Optional__. Animation width
 * @property integer $height __Required: Optional__. Animation height
