 ...
 * @property boolean $protect_content __Required: Optional__. Protects the contents of the forwarded message from forwarding and saving
 * @property integer $message_id __Required: Yes__. Message identifier in the chat specified in from_chat_id
 */
