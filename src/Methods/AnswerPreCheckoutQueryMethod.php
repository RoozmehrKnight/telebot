 ...
 * @property boolean $ok __Required: Yes__. Specify True if everything is alright (goods are available, etc.) and the bot is ready to proceed with the order. Use False if there are any problems.
...
class AnswerPreCheckoutQueryMethod extends TelegramMethod
{
	...
	protected array $parameters = ['pre_checkout_query_id' => 'string', 'ok' => 'boolean', 'error_message' => 'string'];
}
