 ...
 *
 * @property integer $user_id __Required: Yes__. User identifier of created sticker set owner
 ...
 * @property boolean $contains_masks __Required: Optional__. Pass True, if a set of mask stickers should be created
